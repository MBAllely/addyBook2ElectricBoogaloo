...
_A more comprehensive address book.  An exercise in JavaScript and jQuery_


## Setup/Installation Requirements

1. Fork and clone this repository from [gitHub](https://github.com/MBAllely/addyBook2ElectricBoogaloo)
...
Copyright (c) 2016 **_Marika Allely_** (In All Her Glory)
